...
//  Primary profile: XIAO ESP32-S3 Sense
...
static const cam_profile_t CAM_PROFILES[] = {
    {"AI-Thinker ESP32-S3 / ESP32-S3-EYE / Freenove S3", {-1, -1, 15, 4, 5, 16, 17, 18, 12, 10, 8, 9, 11, 6, 7, 13}, -1},
    {"nulllab ESP32-S3-CAM (8MB OPI, OV3660)", {-1, -1, 15, 4, 5, 16, 17, 18, 12, 10, 8, 9, 11, 6, 7, 13}, 3},
    {"XIAO ESP32-S3 Sense", {-1, -1, 10, 40, 39, 48, 11, 12, 14, 16, 18, 17, 15, 38, 47, 13}, 21},
    {"DFRobot FireBeetle 2 ESP32-S3", {-1, -1, 45, 1, 2, 48, 46, 8, 7, 4, 41, 40, 39, 6, 42, 5}, -1},
    {"DFRobot ESP32-S3 AI CAM (OV3660)", {-1, -1, 5, 8, 9, 4, 6, 7, 14, 17, 21, 18, 16, 1, 2, 15}, 3},
    {"ESP32-S3-CAM (LCD variant)", {-1, -1, 40, 17, 18, 39, 41, 42, 12, 3, 14, 47, 13, 21, 38, 11}, -1},
};
